...
exercise("Creating a plot of our own",
         p("Make a scatterplot of conservation status vs. time spent awake"),
...
exercise("Another plot example",
         p("How would I make a scatterplot of conservation status (data$conservation) vs 
           ...
           Bonus points if you add axis labels and a title."))
```
...
Chances are, you might not be instantly "in love" with ggplot2's default theme.
Fear not - there are several other themes you can use to choose from.
Using the gapminder dataset as an example, let's check out several different themes.
...
A more traditional, minimal theme. 
This is my personal favorite and I use it for everything:
...
For some additional themes, check out the [`ggthemes` package](https://github.com/jrnold/ggthemes).
